...
The Agent-Native **Plan** app ships as one installable bundle. A single install adds the Plan slash-command skills **and** wires up the hosted Plan MCP connector, so the agent can generate plans and the skills can publish them straight into the Plan app.
...
<div class="diagram-routes">
  ...
  <div class="diagram-box">
    Plan MCP connector<br /><small class="diagram-muted"
      >plan.agent-native.com/_agent-native/mcp</small
    >
  </div>
</div>
```
