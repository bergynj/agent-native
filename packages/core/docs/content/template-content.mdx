...
<Diagram id="doc-block-159ykca" title="One document, many editors" summary={"You and the agent both write through the same Yjs pipeline. SQL is the canonical store; local files and Notion are optional sync surfaces."}>
...
<div class="diagram-flow">
  ...
  <div class="diagram-panel center">
    ...
    ><small class="diagram-muted">live, conflict-free merge</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
