...
<WireframeBlock id="doc-block-8yyxru">
  <Screen
    surface="desktop"
    html={
...
<Diagram id="doc-block-12kx1a9" title={"Orquestre, não se especialize"} summary={"As mensagens de todos os canais chegam a uma caixa de entrada; o orquestrador faz a triagem e delega o trabalho do domínio para o aplicativo especializado certo em A2A — segredos, recursos e aprovações permanecem centrais."}>
...
<div class="diagram-dispatch">
  <div class="diagram-col">
    ...
    <div class="diagram-node">Solicitações A2A</div>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box" data-rough>
    <span class="diagram-pill accent">Orchestrator</span
    ><small class="diagram-muted">caixa central · triagem · roteamento</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-col">
    <div class="diagram-node">Agente Mail</div>
    <div class="diagram-node">Agente Analytics</div>
...
<div class="diagram-shared">
  ...
  ><span class="diagram-pill">Jobs agendados</span>
</div>
```
...
<DataModel
  id="doc-block-1i66b44"
  title="Esquema do cofre de segredos"
  summary={
  ...
  entities={[
    {
      id: "secrets",
      name: "vault_secrets",
      note: "Valores de credenciais armazenados",
      fields: [
        {
          name: "id",
          type: "text",
    ...
    },
    {
      id: "grants",
      name: "vault_grants",
      note: "Concessão de acesso por aplicativo",
      fields: [
        {
          name: "id",
          type: "text",
    ...
    },
    {
      id: "requests",
      name: "vault_requests",
      note: "Solicitação de acesso + revisão",
      fields: [
        {
          name: "id",
          type: "text",
    ...
    },
    {
      ...
      note: "Quem usou qual segredo quando",
      fields: [
        {
          name: "id",
          type: "text",
