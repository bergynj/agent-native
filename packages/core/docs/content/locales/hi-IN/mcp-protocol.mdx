...
<Diagram id="doc-block-q7mc43" title={"आपका ऐप MCP सर्वर के रूप में"} summary={"बाहरी होस्ट स्ट्रीम करने योग्य HTTP से जुड़ते हैं। प्रत्येक क्रिया एक उपकरण है; आस्क-एजेंट पूर्ण एजेंट लूप को सौंपता है।"}>
...
<Endpoint id="doc-block-1eenree" title={"MCP समापन बिंदु"} summary={"ऑटो-माउंटेड स्ट्रीमेबल HTTP एंडपॉइंट प्रत्येक एजेंट-नेटिव ऐप को उजागर करता है।"} method="POST" path="/_agent-native/mcp" summary={"MCP स्ट्रीम करने योग्य HTTP समापन बिंदु"} auth="Standard remote MCP OAuth (Bearer access token), connect-minted JWT, or static ACCESS_TOKEN/ACCESS_TOKENS" params={[
  {
    "name": "Authorization",
    "in": "header",
    "type": "string",
...
<Diagram id="doc-block-1gzntim" title={"OAuth खोज प्रवाह"} summary={"401 खोज, पंजीकरण और PKCE अधिकृत → टोकन एक्सचेंज को शुरू करता है। बियरर टोकन ऑडियंस-बाउंड और स्कोप्ड है।"}>
...
<div class="diagram-oauth">
  ...
  <div class="diagram-box" data-rough>
    Bearer access token<br /><small class="diagram-muted"
      >audience से बंधा · mcp:read / write / apps स्कोप</small
    >
  </div>
</div>
```
