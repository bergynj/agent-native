...
- [**Workspace**](/docs/workspace#skills) — App मोड में skills SQL संसाधनों के रूप में कहाँ रहते हैं
