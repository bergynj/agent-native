...
<Diagram id="doc-block-30qxsw" title={"बाह्य-एजेंट राउंड-ट्रिप"} summary={"एक बाहरी होस्ट MCP पर एक टूल को कॉल करता है; ऐप एक आर्टिफैक्ट और एक ओपन लिंक लौटाता है। इसे क्लिक करने से ब्राउज़र सत्र हल हो जाता है और चल रहे यूआई में आर्टिफैक्ट केंद्रित हो जाता है - लिंक में कोई विशेषाधिकार प्राप्त स्थिति नहीं होती है।"}>

```html
<div class="xa-trip">
  <div class="diagram-box" data-rough>
    बाहरी होस्ट<br /><small class="diagram-muted"
      >Claude &middot; ChatGPT &middot; Codex &middot; Cursor</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-panel center" data-rough>
    <span class="diagram-pill accent">MCP टूल call</span
    ><small class="diagram-muted">e.g. <code>manage-draft</code></small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box" data-rough>
    ऐप artifact बनाता है<br /><small class="diagram-muted"
      >+ <code>Open in &lt;app&gt; &rarr;</code> deep link / MCP App</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&darr;</div>
  <div class="diagram-box" data-rough>उपयोगकर्ता लिंक क्लिक करता है</div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-panel center" data-rough>
  ...
  <div class="diagram-box" data-rough>
    Writes <code>navigate</code> app-state<br /><small class="diagram-muted"
      >UI artifact पर फोकस करती है</small
    >
  </div>
</div>
```
...
<Diagram id="doc-block-nba1kq" title={"दो कैटलॉग स्तर"} summary={"प्रत्येक कॉल करने वाले को डिफ़ॉल्ट रूप से कॉम्पैक्ट टियर मिलता है; पूर्ण ~105-टूल सतह केवल ऑप्ट-इन है। टूल-सर्च अंतर को पाटता है इसलिए कुछ भी वास्तव में छिपा नहीं है।"}>
