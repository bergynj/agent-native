...
`view-screen` और `navigate` को extend करें ताकि agent current route जान सके और `/response-insights` खोल सके. Results में `href: "/response-insights"` भी हो सकता है, जिससे chat में "Open response insights" button दिखे.
