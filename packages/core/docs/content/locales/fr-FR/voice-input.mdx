...
Le modèle vocal utilise les mêmes outils Agent Native authentifiés que le chat. Il peut donc parcourir l’application et appeler des actions tout en parlant. Les actions soumises à approbation restent en pause jusqu’à votre accord. L’audio n’est jamais stocké dans SQL ; Agent Native ne conserve qu’un état compact de la session et de la transcription. Une session en temps réel dure au maximum 60 minutes.
