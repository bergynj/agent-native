...
<WireframeBlock id="doc-block-574eee">
  <Screen
    surface="desktop"
    html={
...
<Diagram id="doc-block-1afqf0p" title={"Orchestrez, ne vous spécialisez pas"} summary={"Les messages de chaque canal arrivent dans une seule boîte de réception ; l'orchestrateur trie et délègue le travail de domaine à l'application spécialisée appropriée via A2A : les secrets, les ressources et les approbations restent centraux."}>
...
<div class="diagram-dispatch">
  <div class="diagram-col">
    ...
    <div class="diagram-node">Requêtes A2A</div>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box" data-rough>
    <span class="diagram-pill accent">Orchestrator</span
    ><small class="diagram-muted">boîte centrale · tri · routage</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-col">
    <div class="diagram-node">Agent Mail</div>
    <div class="diagram-node">Agent Analytics</div>
...
<DataModel
  id="doc-block-c8ms7d"
  title={"Schéma du coffre-fort de secrets"}
  summary={
  ...
  entities={[
    {
      id: "secrets",
      name: "vault_secrets",
      note: "Valeurs d'informations d'identification stockées",
      fields: [
        {
          name: "id",
          type: "text",
    ...
    },
    {
      id: "grants",
      name: "vault_grants",
      note: "Octroi d'accès par application",
      fields: [
        {
          name: "id",
          type: "text",
    ...
    },
    {
      ...
      note: "Qui a utilisé quel secret quand",
      fields: [
        {
          name: "id",
          type: "text",
