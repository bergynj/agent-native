...
<Diagram id="doc-block-xf7qil" title={"Was passiert bei jedem PR-Push?"} summary={"Ein begrenztes Diff speist einen echten Codierungsagenten, der eine Zusammenfassung erstellt; Der Workflow macht einen Screenshot davon und fügt einen Sticky-Kommentar ein."}>
...
<div class="diagram-recap">
  ...
  <div class="diagram-node">
    Coding-Agent<br /><small class="diagram-muted"
      >Claude Code / Codex liest Diff</small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  ...
  <div class="diagram-box">
    Ein angehefteter PR-Kommentar<br /><small class="diagram-muted"
...
<Diagram id="doc-block-cd4zy4" title="Fork PR-Zustimmungstor" summary={"Fork-PRs erhalten standardmäßig keine Geheimnisse; Vertrauenswürdige Autoren werden automatisch ausgeführt und externe Mitwirkende benötigen ein neues Betreuer-Recap-Label."}>
...
<div class="diagram-fork">
  ...
  <div class="diagram-card">
    ...
    ><small class="diagram-muted"
      >Maintainer prüft Diff und wendet ihn dann an <code>recap</code></small
    >
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-panel center">
  ...
  <div class="diagram-box ok">
    Recap-Läufe<br /><small class="diagram-muted"
      >nur Code aus Basis-Repo · Fork-Diff ist Texteingabe</small
    >
  </div>
</div>
```
...
# Literale Teilzeichenfolge – jede Diff-Zeile, die diese Zeichenfolge enthält, ist zulässig.
...
# Thin Caller – die gesamte Workflow-Logik befindet sich in BuilderIO/agent-native.
# Korrekturen und Verbesserungen erreichen dieses Repo automatisch bei jedem Lauf.
# Um eine bestimmte Version zur Reproduzierbarkeit anzupinnen, ersetzen Sie „@main“ durch a
# Tag oder SHA, z.B. „@v1.2.3“ oder „@abc1234“.
