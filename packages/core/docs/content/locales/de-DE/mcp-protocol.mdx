...
<Diagram id="doc-block-1qgiacx" title="Ihre App als MCP-Server" summary={"Externe Hosts verbinden sich über Streamable HTTP. Jede Aktion ist ein Werkzeug; ask-agent delegiert an die vollständige Agentenschleife."}>
...
<Endpoint id="doc-block-arbi17" title="MCP Endpunkt" summary={"Der automatisch gemountete Streamable HTTP-Endpunkt, den jede agentennative App verfügbar macht."} method="POST" path="/_agent-native/mcp" summary="MCP Streambarer HTTP Endpunkt" auth="Standard remote MCP OAuth (Bearer access token), connect-minted JWT, or static ACCESS_TOKEN/ACCESS_TOKENS" params={[
  {
    "name": "Authorization",
    "in": "header",
    "type": "string",
...
<Diagram id="doc-block-hsvr0w" title="OAuth Erkennungsablauf" summary={"Ein 401 leitet die Erkennung, Registrierung und einen PKCE-Autorisierung → Token-Austausch ein. Der Bearer-Token ist an die Zielgruppe gebunden und hat einen Gültigkeitsbereich."}>
...
<div class="diagram-oauth">
  ...
  <div class="diagram-box" data-rough>
    Bearer access token<br /><small class="diagram-muted"
      >audience-gebunden · mcp:read / write / apps</small
    >
  </div>
</div>
```
