...
<WireframeBlock id="doc-block-r8zil6">
  <Screen
    surface="desktop"
    html={
...
<Diagram id="doc-block-1rzdgj8" title={"専門化せずにオーケストレーションする"} summary={"すべてのチャネルからのメッセージが 1 つの受信箱に届きます。オーケストレーターは、A2A を介してドメインの作業を優先順位付けし、適切な専門アプリに委任します。シークレット、リソース、承認は中心的な役割を果たします。"}>
...
<div class="diagram-dispatch">
  <div class="diagram-col">
    ...
    <div class="diagram-node">A2Aリクエスト</div>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box" data-rough>
    <span class="diagram-pill accent">Orchestrator</span
    ><small class="diagram-muted">中央受信箱 · トリアージ · ルーティング</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-col">
    <div class="diagram-node">Mail エージェント</div>
    <div class="diagram-node">Analytics エージェント</div>
...
<DataModel
  id="doc-block-1gfu52k"
  title={"Secrets ボールトのスキーマ"}
  summary={
