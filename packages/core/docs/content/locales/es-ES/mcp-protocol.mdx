...
<Endpoint id="doc-block-1t35cn" title="Endpoint MCP" summary={"El punto final Streamable HTTP montado automáticamente que expone cada aplicación nativa del agente."} method="POST" path="/_agent-native/mcp" summary="MCP Punto final HTTP transmitible" auth="Standard remote MCP OAuth (Bearer access token), connect-minted JWT, or static ACCESS_TOKEN/ACCESS_TOKENS" params={[
  {
    "name": "Authorization",
    "in": "header",
    "type": "string",
