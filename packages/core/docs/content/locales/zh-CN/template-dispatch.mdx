...
<WireframeBlock id="doc-block-mmo2dc">
  <Screen
    surface="desktop"
    html={
...
<Diagram id="doc-block-1io92sj" title={"统筹安排，不要专门化"} summary={"来自每个渠道的消息都会集中在一个收件箱中；编排器通过 A2A 对域工作进行分类和委托给正确的专业应用程序 — 秘密、资源和批准保持核心。"}>
...
<div class="diagram-dispatch">
  <div class="diagram-col">
    ...
    <div class="diagram-node">A2A 请求</div>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-box" data-rough>
    <span class="diagram-pill accent">Orchestrator</span
    ><small class="diagram-muted">中央收件箱 · 分诊 · 路由</small>
  </div>
  <div class="diagram-arrow diagram-muted" aria-hidden="true">&rarr;</div>
  <div class="diagram-col">
    <div class="diagram-node">邮件 Agent</div>
